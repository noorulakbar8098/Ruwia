...
object RuwiaColor {
    ...
    internal var animTealLight      by mutableStateOf(Color(0xFF123A39))
    internal var animTealExtraLight by mutableStateOf(Color(0xFF123A39))
    internal var animMint           by mutableStateOf(Color(0xFF111C1F))
    internal var animMintLight      by mutableStateOf(Color(0xFF16262A))
    ...
    internal var animNavBackground  by mutableStateOf(Color(0xFF0F2B29))
    internal var animTextPrimary    by mutableStateOf(Color(0xFFF5F7F8))
    internal var animTextSecondary  by mutableStateOf(Color(0xFFA7B5B9))
    internal var animTextMuted      by mutableStateOf(Color(0xFF7F959A))
    internal var animDisabled       by mutableStateOf(Color(0xFF5C6B70))
    internal var animDivider        by mutableStateOf(Color(0xFF1D3135))
    internal var animLightGray      by mutableStateOf(Color(0xFF16262A))
    internal var animNavActiveChip  by mutableStateOf(Color(0xFF155B56))
    internal var animSummaryBorder  by mutableStateOf(Color(0xFF1F5451))
