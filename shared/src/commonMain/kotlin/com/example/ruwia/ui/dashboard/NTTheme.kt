...
object NTColors {
    ...
    // Backing states for dynamic animated colors (initially Light Mode defaults)
    internal var animPrimary by mutableStateOf(Color(0xFF0F9D8A))
    internal var animPrimaryLight by mutableStateOf(Color(0xFFDDF5F1))
    internal var animPrimaryMid by mutableStateOf(Color(0xFF14B8A6))
    internal var animPrimaryDark by mutableStateOf(Color(0xFF0D8A7A))
    internal var animPrimaryDeep by mutableStateOf(Color(0xFF0A6F62))

    internal var animAccent by mutableStateOf(Color(0xFFF97316))
    internal var animAccentLight by mutableStateOf(Color(0xFFFED7AA))
    internal var animAccentDark by mutableStateOf(Color(0xFFEA580C))

    internal var animBackground by mutableStateOf(Color(0xFFF7FAF8))
    internal var animSurface by mutableStateOf(Color(0xFFFFFFFF))
    internal var animSurfaceVar by mutableStateOf(Color(0xFFF3F7F6))
    ...
    internal var animTextTertiary by mutableStateOf(Color(0xFF8BA0A5))
    internal var animTextDisabled by mutableStateOf(Color(0xFFB0C0C4))
    ...
    internal var animSuccessLight by mutableStateOf(Color(0xFFD1FAE5))
    internal var animSuccessText by mutableStateOf(Color(0xFF065F46))

    internal var animWarning by mutableStateOf(Color(0xFFF59E0B))
    internal var animWarningLight by mutableStateOf(Color(0xFFFEF3C7))
    internal var animWarningText by mutableStateOf(Color(0xFF92400E))

    internal var animError by mutableStateOf(Color(0xFFEF4444))
    internal var animErrorLight by mutableStateOf(Color(0xFFFEE2E2))
    internal var animErrorText by mutableStateOf(Color(0xFF991B1B))

    internal var animInfo by mutableStateOf(Color(0xFF3B82F6))
    internal var animInfoLight by mutableStateOf(Color(0xFFDBEAFE))
    internal var animInfoText by mutableStateOf(Color(0xFF1E40AF))

    internal var animBorder by mutableStateOf(Color(0xFFD8E4E2))
    internal var animDivider by mutableStateOf(Color(0xFFD8E4E2))

    internal var animShimmerBase by mutableStateOf(Color(0xFFE2E8F0))
    internal var animShimmerHigh by mutableStateOf(Color(0xFFF8FAFC))

    internal var animAvatarGold by mutableStateOf(Color(0xFFD4844C))
    internal var animAvatarTeal by mutableStateOf(Color(0xFF0F9D8A))
    ...
    internal var animGradStart by mutableStateOf(Color(0xFF0F9D8A))
    internal var animGradEnd by mutableStateOf(Color(0xFF0A6F62))
    internal var animGradAccent by mutableStateOf(Color(0x300F9D8A))

    internal var animChartLine by mutableStateOf(Color(0xFF0F9D8A))
    internal var animChartFillTop by mutableStateOf(Color(0x600F9D8A))
    internal var animChartFillBot by mutableStateOf(Color(0x000F9D8A))
    internal var animChartGrid by mutableStateOf(Color(0xFFD8E4E2))
    internal var animChartLabel by mutableStateOf(Color(0xFF607176))

    internal var animSaleIconBg by mutableStateOf(Color(0xFFDDF5F1))
    internal var animSaleIconFg by mutableStateOf(Color(0xFF0F9D8A))
    internal var animStockIconBg by mutableStateOf(Color(0xFFEDE9FE))
    internal var animStockIconFg by mutableStateOf(Color(0xFF8B5CF6))
    internal var animOverdueIconBg by mutableStateOf(Color(0xFFFEE2E2))
    internal var animOverdueIconFg by mutableStateOf(Color(0xFFEF4444))
    internal var animPayIconBg by mutableStateOf(Color(0xFFD1FAE5))
    internal var animPayIconFg by mutableStateOf(Color(0xFF10B981))
    internal var animDelivIconBg by mutableStateOf(Color(0xFFDBEAFE))
    internal var animDelivIconFg by mutableStateOf(Color(0xFF3B82F6))
    internal var animCancelIconBg by mutableStateOf(Color(0xFFF3F7F6))
    internal var animCancelIconFg by mutableStateOf(Color(0xFF607176))
    internal var animPendIconBg by mutableStateOf(Color(0xFFFEF3C7))
